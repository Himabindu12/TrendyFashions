                ...
                <div class="item active">
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/p1.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/m1.jpg" class="img-responsive" alt="a" height=100px />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/p2.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/m2.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                ...
                <div class="item">
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/p3.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/m3.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/p4.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/m4.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                ...
                <div class="item active">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/k1.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-4">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/k2.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-4">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/k3.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                ...
                <div class="item">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/k4.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-4">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/k5.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
                        ...
                        <div class="col-sm-4">
                            <div class="col-item">
                                <div class="photo">
                                    <img src="${img}/k6.jpg" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="row">
                                        <div class="price col-md-6">
