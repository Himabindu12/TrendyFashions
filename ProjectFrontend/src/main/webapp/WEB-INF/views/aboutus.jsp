...
<form>
<fieldset>
<legend>AboutUs</legend>
Address: <input type="text" value="Banglore" placeholder="Banglore"><br><br>
Phone number:<input type="text" value="967342567" placeholder="967342567"><br><br><br>
