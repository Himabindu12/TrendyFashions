...
Product Id: <input type="text" name="productId" placeholder="Enter ProductId"><br><br>
Product Name:<input type="text" name="catName" placeholder="Enter ProductName"><br><br><br>
Price:<input type="text" name="price" placeholder="Enter Price"><br><br><br>
Quantity:<input type="text" name="quantity" placeholder="Enter Quantity"><br><br><br>
Description:<input type="text" name="description" placeholder="Enter Description"><br><br><br>
