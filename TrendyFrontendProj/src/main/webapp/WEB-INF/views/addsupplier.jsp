...
Supplier Id: <input type="text" name="supplierId" placeholder="Enter Supplier Id"><br><br>
Supplier Name:<input type="text" name="supplierName" placeholder="Enter Supplier Name"><br><br><br>
Mobile number:<input type="text" name="Mobile number" placeholder="Enter Mobile Number"><br><br><br>
